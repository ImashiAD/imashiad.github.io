      ...
      <div className="starry-wrapper">
        <div className="sub-container">
          ...
          <div className="content">
            ...
            <p>
              A UI/UX Designer crafting functional, human-centered interfaces
              for complex systems. I transform technical requirements into
              intuitive design — because good UI shouldn't need a manual.
            </p>
